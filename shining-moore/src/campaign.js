...
export const SCENES = {
  ...
  post0: [
    ...
    ['zin', 'ZIN', 'AND TAKE ME AS WELL. YOU WILL NEED FIRE BEFORE THE END. I AM FIRE.'],
    ['moore', 'MOORE', 'WELCOME, BOTH. WE MARCH FOR THE BRIDGE AT DAWN.'],
  ],
  pre1: [
  ...
  post1: [
    ['kael', 'KAEL', 'THE FAR BANK IS OURS. THE ROAD TO THE VILLAGES LIES OPEN.'],
    ['moore', 'MOORE', 'THEN ON TO THE WOODS. STAY SHARP -- VEXMOORE KNOWS WE ARE COMING.'],
  ],
  pre2: [
