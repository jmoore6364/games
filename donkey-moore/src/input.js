// Input: keyboard, gamepad, and on-screen touch controls (D-pad + jump).
// Donkey Moore scheme: Left/Right run, Up/Down climb ladders, Space/Z jump.
...
const MAP = {
  ...
  KeyZ: 'jump', Space: 'jump', KeyX: 'jump', KeyK: 'jump',
  Enter: 'start',
  KeyM: 'mute',
};
...
export class Input {
  ...
  // Standard-mapping gamepad: dpad/left stick, A=jump, Start=start.
  pollGamepad() {
...
export function initTouch(input) {
  ...
  mkBtn('START', 'start', 'b-start');
  mkBtn('MUTE', 'mute', 'b-mute');
