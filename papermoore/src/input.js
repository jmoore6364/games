// Input: keyboard, gamepad and touch. Actions: left/right steer, up=faster,
// down=brake, throw (paper / bunny-hop), start (pause/confirm), mute.
...
const MAP = {
  ...
  KeyX: 'throw', Space: 'throw', KeyJ: 'throw', KeyZ: 'throw',
...
export class Input {
  ...
  // Standard-mapping gamepad: dpad/left stick, A/X=throw, Start=start.
  pollGamepad() {
