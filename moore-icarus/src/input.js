// Input: keyboard, gamepad, and on-screen touch controls.
// Kid Icarus scheme: Up = aim up / enter a door, Down = crouch, X = shoot.
...
export class Input {
  ...
  // Standard-mapping gamepad: dpad/left stick, A=jump, X/B=fire, Start=start.
  pollGamepad() {
